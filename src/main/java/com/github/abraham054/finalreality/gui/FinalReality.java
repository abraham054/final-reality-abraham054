...
public class FinalReality extends Application {
    ...
    private void createNextTurnButton(Group root) {
    ...
    private void refreshLostScene(){
        Scene lostScene = createLostScene();
